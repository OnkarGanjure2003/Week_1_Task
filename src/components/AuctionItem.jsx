...
function AuctionItem() {
	...
	useEffect(() => {
		...
		const fetchWinner = async () => {
			try {
				console.log("Fetching winner for auction ID:", id);
				const res = await axios.get(`/api/auctions/winner/${id}`);
				console.log("Winner response:", res.data);
	...
	return (
		<div className="max-w-4xl p-8 mx-auto mt-10 text-black bg-white rounded-lg shadow-lg">
			...
			>
				...
				{isAuctionEnded && !winner && (
					<div className="p-4 mt-6 font-bold text-center text-black bg-yellow-500 rounded-lg">
						<h3 className="text-2xl text-blue-600">No Winner !</h3>
